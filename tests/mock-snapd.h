...
void           mock_snapd_set_close_on_request       (MockSnapd *snapd, gboolean close_on_request);
...
void           mock_snapd_set_maintenance            (MockSnapd *snapd, const gchar *type, const gchar *message);
...
void           mock_snapd_add_sandbox_feature        (MockSnapd *snapd, const gchar *backend, const gchar *feature);
...
void           mock_snapd_add_store_section          (MockSnapd *snapd, const gchar *name);
...
MockChannel   *mock_track_add_channel                (MockTrack *track, const gchar *risk, const gchar *branch);

void           mock_channel_set_confinement          (MockChannel  *channel, const gchar *confinement);
...
void           mock_channel_set_released_at          (MockChannel  *channel, const gchar *released_at);
...
void           mock_snap_set_icon_data               (MockSnap *snap, const gchar *mime_type, GBytes *data);
...
void           mock_snap_set_publisher_display_name  (MockSnap *snap, const gchar *display_name);
...
void           mock_snap_set_publisher_validation    (MockSnap *snap,  const gchar *validation);
...
MockMedia     *mock_snap_add_media                   (MockSnap *snap, const gchar *type, const gchar *url, int width, int height);
...
void           mock_snap_add_store_section           (MockSnap *snap, const gchar *section);

MockPlug      *mock_snap_add_plug                    (MockSnap *snap, MockInterface *interface, const gchar *name);

MockPlug      *mock_snap_find_plug                   (MockSnap *snap, const gchar *name);

void           mock_plug_add_attribute               (MockPlug *plug, const gchar *name, const gchar *value);

MockSlot      *mock_snap_add_slot                    (MockSnap *snap, MockInterface *interface, const gchar *name);

MockSlot      *mock_snap_find_slot                   (MockSnap *snap, const gchar *name);

void           mock_slot_add_attribute               (MockSlot *slot, const gchar *name, const gchar *value);

void           mock_snapd_connect                    (MockSnapd *snapd, MockPlug *plug, MockSlot *slot, gboolean manual, gboolean gadget);
